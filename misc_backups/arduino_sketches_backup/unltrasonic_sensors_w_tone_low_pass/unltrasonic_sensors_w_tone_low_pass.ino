...
////int level = map(average, 0, maxDistance, NOTE_C6, NOTE_C3);
int level = map(distance, 0, 30, NOTE_C6, NOTE_C2);
//int level = map(average, 0, 40, NOTE_B2, NOTE_C4);

...
//    Serial.print(aSin0.next());
//    Serial.print('\t');
//    Serial.print(aSin1.next());
//    Serial.print('\t');
//    Serial.print(aSin2.next());
//    Serial.print('\t');
//    Serial.print(aSin2.next()>>1);
//    Serial.print('\t');
//    Serial.print(aSin3.next());
//    Serial.print('\t');
//    Serial.print(aSin3.next()>>2);
//    Serial.print('\n');

...
//    Drive(110,70,1625);					// execute code
//    Drive(90,90,2000);					// execute code
//    //Drive(110,110,383);					// CW turn
//    Drive(70,70,383);					// CCW turn
//    Drive(90,90,2000);					// execute code
//
//Drive(90,90,10000);          // execute code
Drive(110,70,1565);         // execute code
Drive(110,90,124);         // execute code
Drive(90,90,2000);          // execute code
//Drive(110,110,383);         // CW turn
//Drive(110,110,430);         // CCW turn
//Drive(70,70,398);         // CCW turn
//Drive(70,90,30);         // CCW turn
//Drive(110,110,398);         // CCW turn
//Drive(110,90,30);         // CCW turn
Drive(110,110,436);         // CCW turn
//Drive(70,70,447);         // CCW turn
//Drive(110,90,30);         // CCW turn
Drive(90,90,2000);          // execute code
  }

	...
	; Compiler options:
	;
	; -odigital_voltage_interrupt.cof -mdigital_voltage_interrupt.map \
	; --summary=default --output=default digital_voltage_interrupt.p1 \
	; --chip=12LF1822 -P --runtime=default --opt=default -D__DEBUG=1 -g \
